    ...
    <button
      ...
      className={`w-full rounded-xl border px-4 py-3.5 text-left text-base font-medium transition-all ${
        selectedValue === option.id
          ? "border-[#1a3d6b] bg-[#1a3d6b]/10 text-gray-900"
          : "border-gray-200 bg-white text-gray-700 hover:border-[#1a3d6b]/50 hover:bg-gray-50"
      }`}
    >
      {option.label}
    </button>
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Home className="h-5 w-5 text-[#1a3d6b]" />
        ...
        {step === 1 && (
          <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-center -mb-2">
              <ArrowDown className="h-6 w-6 text-[#1a3d6b] animate-bounce" />
            </div>
            <AddressAutocomplete
            ...
            <Button
              onClick={handleNext}
              disabled={!canProceed()}
              className="w-full h-14 bg-[#1a3d6b] text-white text-lg font-semibold rounded-xl hover:bg-[#0f2440] disabled:opacity-40 transition-all shadow-md hover:shadow-lg"
            >
              Get My Cash Offer
            ...
            <div className="flex flex-col gap-3">
              <div>
                <Input
                  ...
                  className={`h-14 rounded-xl border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus:border-[#1a3d6b] focus:ring-[#1a3d6b]/20 ${validationErrors.name ? "border-red-500" : ""}`}
                />
              ...
              <div>
                <Input
                  ...
                  className={`h-14 rounded-xl border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus:border-[#1a3d6b] focus:ring-[#1a3d6b]/20 ${validationErrors.email ? "border-red-500" : ""}`}
                />
              ...
              <div>
                <Input
                  ...
                  maxLength={14}
                  className={`h-14 rounded-xl border-gray-200 bg-white text-gray-900 placeholder:text-gray-400 focus:border-[#1a3d6b] focus:ring-[#1a3d6b]/20 ${validationErrors.phone ? "border-red-500" : ""}`}
                />
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="mt-4 flex flex-col gap-3">
            <Button
              ...
              className="w-full bg-[#1a3d6b] text-white hover:bg-[#0f2440]"
            >
